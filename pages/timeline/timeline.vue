	...
	<view id="moments">
		...
		<view class="moments__post cu-item" v-for="(post,index) in posts" :key="index" :id="'post-'+index">
			...
			<view class="post_right">
				<text class="text-timeline text-bold">{{post.username}}</text>
				...
				<div class="cu-item bg-gray padding-lr-sm padding-tb-sm">
					...
					<div class="justify-start text-xl flex">
						<text class="cuIcon-likefill text-xl text-timeline"></text>
						<text class="nickname" v-for="(user,index_like) in post.like" :key="index_like">{{user.username}}</text>
					</div>

					<view class="flex justify-start padding-0" v-for="(comment,comment_index) in post.comments.comment" :key="comment_index"
					 @tap="reply(index,comment_index)">
						<text class="comment-nickname text-timeline">{{comment.username}}: <text class="comment-content">{{comment.content}}</text></text>
					</view>
				</div>
