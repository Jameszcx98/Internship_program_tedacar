<template>
	<view>
		...
		<form>
			...
			<view class="cu-form-group margin-top">
				<textarea maxlength="-1" :disabled="modalName!=null" @input="textareaAInput" placeholder="描述"></textarea>
			</view>
			...
			<button class="cu-btn bg-green lg">开始估值</button>
			</view>
		</form>
	</view>
</template>
