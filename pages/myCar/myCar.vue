<template>
	<view>
		...
		<view class="main">
			...
			<view class="cu-bar bg-white padding-tb-xs" style="min-height: auto;">
				<view class="padding-left padding-tb-sm">
					<text class="">2014款 奥迪 A8L 3.0T 自动 45TFSI豪华型四驱</text>
				</view>
				<view class="action">
					<view class="cu-avatar round margin-left" style="background-image:url('https://ossweb-img.qq.com/images/lol/web201310/skin/big10001.jpg'); margin-left: 30rpx;"></view>
				</view>
			</view>

			<view class="cu-bar bg-white padding-tb-xs" style="min-height: auto;">
				<view class='padding cu-tag bg-white text-gray text-sm'>第1067位认证车主：<text class="text-bold text-gray text-sm">GaryLee</text></view>
				<view class="action">
					<view class="cu-tag bg-red radius">关注</view>
				</view>
			</view>

			<view class="cu-bar bg-white margin-bottom-sm padding-tb-xs" style="min-height: auto;">
				<view class="">
					<view class='padding cu-tag bg-white text-gray text-sm'>2347围观 218赞<text class="cuIcon-appreciate text-gray"></text></view>
				</view>
			</view>

			<scroll-view scroll-x class="bg-white nav">
				<view class="flex text-center">
					<view class="cu-item flex-sub text-gray" :class="index==TabCur?'text-teda cur':''" v-for="(item,index) in goodList5"
			...
			<view class="cu-bar bg-white">
				<view class="padding-left ">
					<text class="text-lg">配置清单</text>
				</view>
				<view class="padding-left padding-tb-xs">
					<text class="text-lg padding-right">¥141,900</text>
				</view>
			</view>
			<view class="cu-bar bg-white padding-bottom-xs solid-bottom" style="min-height: auto;">
				<view class="padding-left ">
					<text class="text-sm text-gray">奥迪 A8L 2014款 45TFSI豪华型四驱</text>
				</view>
				<view class="padding-right">
					<text class="text-sm text-gray">合计16,890</text>
				</view>
			</view>
			...
			<view class="cu-bar bg-white padding-tb-xs solid-bottom" style="min-height: auto;" v-for="(x,index) in myCarList1"
			 :key="index">
				<view class="padding-left ">
					<text class=""><text class="cuIcon-title text-gray padding-right-xs"></text>{{x.desc}}</text>
				</view>
				<view class="padding-right">
					<text class="text-sm text-gray">{{x.num}}</text>
				</view>
			</view>
			...
			<view class="cu-bar bg-white padding-tb-xs solid-bottom" style="min-height: auto;" v-for="(x,index) in myCarList2"
			 :key="index">
				<view class="padding-left ">
					<text class=""><text class="cuIcon-title text-gray padding-right-xs"></text>{{x.desc}}</text>
				</view>
...
<script>
	...
	export default {
		...
		onLoad() {
			...
			this.myCarList1 = data.myCarList1
