	...
	<view>
		<view class="sunsin_picture_list">
			...
			<view>
				...
				>
					<view
						class="sunsin_add_image"
						@click="chooseImage(upImgConfig.count)"
						:style="'background-color:' + upImgConfig.upBgColor + ''"
						v-show="!upImgConfig.isAddImage || false"
					>
						<!-- 这里可以改为字体图标/iconfont -->
						<view
							class="icon-basic"
							:class="upImgConfig.upSvgIconName == undefined || upImgConfig.upSvgIconName == '' ? 'icon-addicon' : upImgConfig.upSvgIconName"
						></view>
